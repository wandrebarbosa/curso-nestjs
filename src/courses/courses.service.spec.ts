...
type MockRepository<T = any> = Partial<Record<keyof Repository<T>, jest.Mock>>; //definindo um jest mock para usar todos os metodos do meu serviço de forma mocada.
...
describe('CourseService', () => {
    ...
    describe('findOne', () => {
        describe('buscar curso pelo ID', () => {
            it('deve retorna um objeto Course', async () => {
                const courseId = '1';
